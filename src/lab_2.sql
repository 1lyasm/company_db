...
FROM
	department as d,
	dept_locations as dloc
WHERE
	d.dnumber = dloc.dnumber and
	d.dname = 'Sales';
...
FROM
	...
	department as d
WHERE
	dependent.essn = e.ssn and
	e.dno = d.dnumber and
	dependent_name = 'Alice' and
...
WHERE
	e.ssn = dep.essn and
	mng.ssn = e.superssn and
	dep.dependent_name = 'Elizabeth'
